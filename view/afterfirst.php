...
<html>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-4">
        <input type="date" class="form-control" id="inputEmail3" readonly value="<?php echo isset($cr[5])?$cr[5]:'';?>">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-4">
        <input type="date" class="form-control" id="inputPassword3" readonly value="<?php echo isset($cr[6])?$cr[6]:'';?>">
    </div>
  </div>
  <div class="form-group">
